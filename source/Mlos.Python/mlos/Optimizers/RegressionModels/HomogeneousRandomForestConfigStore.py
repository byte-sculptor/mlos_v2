...
homogeneous_random_forest_config_store = ComponentConfigStore(
    parameter_space=SimpleHypergrid(
        ...
        dimensions=[
            DiscreteDimension(name="n_estimators", min=1, max=128),
            ContinuousDimension(name="features_fraction_per_estimator", min=0, max=1, include_min=False, include_max=True),
            ContinuousDimension(name="samples_fraction_per_estimator", min=0.5, max=1, include_min=False, include_max=True),
