...
class RegressionModel(ABC):
    ...
    @abstractmethod
    def fit(self, feature_values_pandas_frame, target_values_pandas_frame, iteration_number) -> None:
        raise NotImplementedError
    ...
    def compute_goodness_of_fit(
        ...
        gof_metrics_by_target_name: Dict[str, GoodnessOfFitMetrics] = {}

        for target_dimension_name in self.target_dimension_names:
            multi_objective_predictions = self.predict(features_df.copy()) # TODO: remove the copy
            predictions =  multi_objective_predictions[target_dimension_name]
            ...
            if num_predictions > 0:
                target_value = target_df.loc[predictions_df.index, target_dimension_name]
            ...
            gof_metrics_by_target_name[target_dimension_name] = gof_metrics

        return gof_metrics_by_target_name
